# Contributing to Llama D5

Thank you for your interest in contributing to Llama D5! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to Llama D5:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llama-d5.git
   cd llama-d5
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llama-d5.git
   ```
...
By contributing to Llama D5, you agree that your contributions will be licensed under the project's MIT License.
